...
-- ------------------ Tareas --------------------------------------------------
insert into tareas (id, titulo, descripcion, fecha, prioridad, categoria, completada, completada_fecha, animal_id, animal_ids, potrero_id, asignado_a_id, asignado_a_ids) values
  ('tar-crono-0704',     'Suministro de agua y forraje',                    null,                                                                     '2026-07-04', 'media','alimentacion', true,  '2026-07-04T18:00:00Z'::timestamptz, null,          '{}'::text[],                                                       null,             'prop-orlando', array['prop-orlando']),
  ('tar-crono-0707',     'Suministro de agua y forraje',                    null,                                                                     '2026-07-07', 'media','alimentacion', true,  '2026-07-07T18:00:00Z'::timestamptz, null,          '{}'::text[],                                                       null,             'prop-nicolas', array['prop-nicolas']),
  ('tar-crono-0709',     'Suministro de agua y forraje + cambio de lote',   'Cambio de lote, se mueve el agua y se pone corriente.',                  '2026-07-09', 'media','manejo',       true,  '2026-07-09T18:00:00Z'::timestamptz, null,          '{}'::text[],                                                       'pot-1',          'prop-orlando', array['prop-orlando','prop-camila']),
  ('tar-crono-0711',     'Rotación de pasturas + cercado eléctrico',        'Se llevó la corriente hasta el fin de la finca primer lote. Inicio de concentrado 2 kg por ternero + sal. Fumigación contra el mosco. Se puso pasto en el lote actual.',
                                                                                                                                                      '2026-07-11', 'alta', 'manejo',       true,  '2026-07-11T18:00:00Z'::timestamptz, null,          array['an-nube','an-pandora','an-canela','an-zeus'],                'pot-fin-finca',  'prop-orlando', array['prop-orlando','prop-rafael','prop-camila']),
  ('tar-crono-0714-rot', 'Rotación + traslado agua + concentrado + sal',    'Inicio nuevo Lote 1.',                                                   '2026-07-14', 'alta', 'manejo',       true,  '2026-07-14T18:00:00Z'::timestamptz, null,          '{}'::text[],                                                       'pot-1',          'prop-orlando', array['prop-orlando','prop-camila']),
  ('tar-crono-0714-vit', 'Vitaminizado + tratamiento a Pandora',            'Ivermectina + crema. Vitamina Over B 8 CC / cabeza.',                    '2026-07-14', 'alta', 'sanidad',      true,  '2026-07-14T18:00:00Z'::timestamptz, 'an-pandora',  array['an-nube','an-pandora','an-canela','an-zeus'],                null,             'prop-orlando', array['prop-orlando','prop-camila']),
  ('tar-crono-0717',     'Suministro de agua y forraje + concentrado',      null,                                                                     '2026-07-17', 'media','alimentacion', true,  '2026-07-17T18:00:00Z'::timestamptz, null,          '{}'::text[],                                                       null,             'prop-camila',  array['prop-camila']),
  ('tar-crono-0721',     'Suministro de agua y forraje + concentrado',      null,                                                                     '2026-07-21', 'media','alimentacion', true,  '2026-07-21T12:00:00Z'::timestamptz, null,          '{}'::text[],                                                       null,             'prop-nicolas', array['prop-nicolas']),
  ('tar-crono-0725',     'Suministro de agua y forraje + concentrado',      'Se arregla poste de luz.',                                                '2026-07-25', 'media','alimentacion', true,  '2026-07-25T18:00:00Z'::timestamptz, null,          '{}'::text[],                                                       null,             'prop-orlando', array['prop-orlando','prop-camila']),
  ('tar-rotar-lote1',    'Rotar potrero — mover a Fin de finca',            'El Lote 1 lleva casi un mes con las 4 cabezas. Revisar pasto antes de mover.', '2026-07-25', 'media','manejo',       false, null,                                null,          '{}'::text[],                                                       'pot-1',          null,           '{}'::text[]),
  ('tar-diag-nube',      'Diagnóstico de preñez — Nube',                    'Palpar / ecografía a los 45 días post-inseminación (18-jun).',          '2026-08-02', 'alta', 'reproduccion', false, null,                                'an-nube',     array['an-nube']::text[],                                            null,             null,           '{}'::text[]),
  ('tar-comprar-sal',    'Comprar sal mineralizada',                        'Quedan menos de 3 kg. Traer bulto nuevo la próxima vez.',                '2026-07-22', 'baja', 'alimentacion', false, null,                                null,          '{}'::text[],                                                       null,             null,           '{}'::text[])
on conflict (id) do nothing;
